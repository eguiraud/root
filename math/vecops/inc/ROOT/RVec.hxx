...
protected:
   ...
   SmallVectorBase(void *FirstEl, size_t TotalCapacity) : BeginX(FirstEl), Capacity(TotalCapacity) {}
...
protected:
   ...
   void resetToSmall()
   {
      ...
      this->fSize = this->Capacity = 0; // FIXME: Setting Capacity to 0 is suspect.
   }
